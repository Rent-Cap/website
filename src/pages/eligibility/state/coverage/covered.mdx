    ...
    {({ appCtx }) => (
        <div>
            ...
            : (appCtx.ab1482TenancyDuration && appCtx.builtBefore2005==='idk') ?
                <p>Good news, we think you are <em>likely</em> to be protected from "unjust" evictions under the Tenant Protection Act, as long are your building hasn't received a "certificate of occupancy" within the last 15 years. Since you didn't know how old your building is we'd recommend connecting with local resources below to find out.</p>
            :
            ...
            <div>
                ...
                <center><PrimaryButton to="/calculator">Find out what my rent cap is</PrimaryButton></center>
            </div>
            :
            <div>
