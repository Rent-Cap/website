...
<AppContext.Consumer>
    {({ appCtx }) => (
        <div>
            ...
            {(appCtx.voucher) ?
            <div>
                <p>Since you receive a voucher to support your housing costs you aren't eligible for capped rent under AB-1482. However you are very likely to have other protections on your rent. If you need help reach out below.</p>
            </div>
