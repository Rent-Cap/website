...
to help you determine what the allowable increase is under the law, and if your rent increase exceeds the limit. Eligible renters who got a rent increase anytime on or after March 15, 2019 should use the rent calculator, as increases in 2019 may be rolled back resulting in a rent reduction.</p>
            <div id="disclaimers">
                {(appCtx.ab1482RentCapEligible !== undefined) ? // if they haven't checked include a link to the eligibility calculator
                    <div class="disclaimer">
                        <p>This calculator assumes you are eligibile for the Tenant Protection Act. If you aren't sure if you are eligible you can use our <a href="">eligibility checker</a>. If you aren't eligible this calculator may over or underestimate the maximum rent increase your landlord could ask for depending on your local laws.</p>
                    </div>
                    : appCtx.ab1482RentCapEligible === false ? // if they have checked but aren't eligible display a warning and reminder
                        <div class="disclaimer">
                            <p>This calculator assumes you are eligibile for the Tenant Protection Act. Your answers to our eligibility checker indicated that you aren't eligiblity for a rent cap under the Tenant Protection Act. Based on your answers this calculator may over or underestimate the maximum rent increase your landlord could ask for depending on your local laws.</p>
                        </div>
                        :
                        <div />
                }
            ...
            <div id="calculator">
                ...
                <div id="calculatorResults">
                    <h2>Maximum Rent</h2>
                    <p class="maxRent">$1232</p>
                    <p>The maximum amount your landlord can ask to increase your rent to today.</p>
                </div>
            </div>
