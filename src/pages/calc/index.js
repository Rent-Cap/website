                                ...
                                <div id="disclaimers">
                                    {(appCtx.ab1482RentCapEligible === undefined) ? // if they haven't checked include a link to the eligibility calculator
                                        <div className="disclaimer">
                                            <p>This calculator assumes you are eligibile for the Tenant Protection Act. If you aren't sure if you are eligible you can use our <a href="">eligibility checker</a>. If you aren't eligible this calculator may over or under estimate the maximum rent increase your landlord could ask for depending on your local laws.</p>
                                        </div>
                        ...
                        <div className="card" id="calculator">
                            <div className="card-body">
                                ...
                                <form>
                                    ...
                                    { (appCtx.moveInAfter15Mar2019 !== undefined && appCtx.rentIncreases !== undefined) ?
                                    <div>
